...
Module Name:
  ...
  CodeCoverageDriverLib.h

Abstract:

  The API definitation for code coverage services in DXE phase. 

**/

#ifndef __CODE_COVERAGE_DRIVER_LIB__
#define __CODE_COVERAGE_DRIVER_LIB__
