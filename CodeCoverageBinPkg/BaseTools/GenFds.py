...
from Common.Misc import CovParser
...
def main():
    ...
    try:
        ...
        try:
            CovcStr = os.environ['COVC']
            CovCofigFile = os.environ['CovCofigFile']
        except:
            CovcStr = ''
            CovCofigFile = ''
        if CovcStr != '' and CovCofigFile != '':
            GlobalData.gCodeCov = CovParser(CovCofigFile)
